...
/// Callbag sink that consume both pullable and listenable sources. When called on a pullable source, it will iterate
/// through its data. When called on a listenable source, it will observe its data.
///
